...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "anandchandrasekaran1912@gmail.com"
...
management_group_settings = {
  ...
  subscription_placement = {
    identity = {
      ...
      management_group_name = "mg-eu-identity"
    }
    connectivity = {
      subscription_id       = "$${subscription_id_connectivity}"
      management_group_name = "mg-eu-connectivity"
    }
    management = {
      subscription_id       = "$${subscription_id_management}"
      management_group_name = "mg-eu-management"
    }
    security = {
      subscription_id       = "$${subscription_id_security}"
      management_group_name = "mg-eu-security"
    }
  }
  policy_assignments_to_modify = {
    mg-eu-jcaptechlabs-root = {
      policy_assignments = {
